 ...
 * @author fatim
 */
public class DriverRideInformation extends javax.swing.JFrame {

    /**
     * Creates new form DriverRideInformation
     */
    public DriverRideInformation() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("DRIVER RIDES INFORMATION");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Driver CNIC", "Ride ID", "Customer Name", "Car Registration Number", "Total Cost"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DriverRideInformation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DriverRideInformation().setVisible(true);
            }
        });
    }
